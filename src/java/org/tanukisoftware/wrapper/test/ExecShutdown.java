...
/**
 * Test WrapperManager.exec after the stop process has already started.
 *  In this case, only detached processes will able to be launched.
 *
 * @author Tanuki Software Development Team &lt;support@tanukisoftware.com&gt;
 */
public class ExecShutdown
{    
    ...
    private static void doTest( String command, String testId, boolean readByteByteByByte, boolean newProcessGroup, boolean autoCloseInputStreams, long expectedTimeMs )
    {
        ...
        try
        {
            WrapperProcessConfig wrapperProcessConfig = new WrapperProcessConfig().setDetached( true ).setNewProcessGroup( newProcessGroup ).setAutoCloseInputStreams( autoCloseInputStreams );
            try
            {
    ...
    public static void main( String[] args )
    {
        ...
        Runtime.getRuntime().addShutdownHook( new Thread()
        {
            public void run() {
                System.out.println( "" );
                System.out.println( Main.getRes().getString( "Test shutdown hook started." ) );
                ...
                System.out.println( Main.getRes().getString( "Test shutdown hook complete." ) );
        ...
        System.out.println( Main.getRes().getString( "Begin shutting down.  Tests will run in a shutdown hook.  All tests will only be able to complete if the wrapper.jvm_exit.timeout is extended to at least NN seconds." ) );
