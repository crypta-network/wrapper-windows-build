    ...
    private void secondLock()
    {
        ...
        try
        {
            if ( rentrantLockClass.isInstance( m_lock2 ) )
            {
                ...
                rentrantLockClass.getMethod( "lock", (Class[])null ).invoke( lock2, (Object[])null );
                try
                {
                    secondLocked();
                }
                ...
                {
                    rentrantLockClass.getMethod( "unlock", (Class[])null ).invoke( lock2, (Object[])null );
                }
            }
            else
            {
    ...
    private void firstLock()
    {
        ...
        if ( rentrantLockClass.isInstance( m_lock1 ) )
        {
            try
            {
                ...
                rentrantLockClass.getMethod( "lock", (Class[])null ).invoke( lock1, (Object[])null );
                try
                {
                    firstLocked();
                }
                ...
                {
                    rentrantLockClass.getMethod( "unlock", (Class[])null ).invoke( lock1, ( Object[] ) null );
                }
            }
            catch ( NoSuchMethodException nsme )
            {
